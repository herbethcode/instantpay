            ...
            <div class="col-lg-8">
                ...
                <div class="post-item-meta mb-4">
                    <ul>
                        ...
                        <li><i class="fa-solid fa-eye"></i> {{ $post->views }} {{ __('views') }}</li>
                        <li><i class="fa-solid fa-comments"></i> {{ $post->approvedComments->count() }} {{ __('comments') }}</li>
                    </ul>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                ...
                                <div class="post-social-sharing wow fadeInUp">
                                    <p class="mb-2"><strong>{{ __('Share this post:') }}</strong></p>
                                    <ul>
                ...
                <div class="post-comments mt-5">
                    <h3 class="mb-4">{{ __('Comments') }} ({{ $post->approvedComments->count() }})</h3>
                    ...
                    <div class="comment-form mt-5">
                        ...
                        <form action="{{ route('blog.comment.store', $post) }}" method="POST">
                            ...
                            <button type="submit" class="btn-default">{{ __('Submit Comment') }}</button>
                            <p class="text-muted mt-2"><small>{{ __('Your comment will be reviewed before being published.') }}</small></p>
                        </form>
                    </div>
                    <!-- Comment Form End -->
                </div>
