        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="page-header-box">
                    <h1 class="text-anime-style-2 text-white" data-cursor="-opaque">{{ __('Our Team') }}</h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h3 class="wow fadeInUp" style="color: #ea2429;">{{ __('Meet Our Team') }}</h3>
                    <h2 class="text-anime-style-2 mb-4" data-cursor="-opaque">{{ __("The People Behind Tanzania's Payment Revolution") }}</h2>
                    <p class="lead wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px; margin: 0 auto;">{{ __('Our team is guided by a strong commitment to integrity, responsibility, and excellence. Together, with discipline and vision, we shape the future of payments and build meaningful solutions for the people we serve.') }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center mb-5">
                    <h3 class="wow fadeInUp" style="color: #ea2429;">{{ __('Leadership') }}</h3>
                    <h2 class="text-anime-style-2 mb-3" data-cursor="-opaque">{{ __('Executive Team') }}</h2>
                    <p class="lead wow fadeInUp" data-wow-delay="0.2s">{{ __('Experienced leaders driving innovation and growth') }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="team-card wow fadeInUp" style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 30px rgba(0,0,0,0.08); transition: transform 0.3s; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                    <div class="team-image" style="height: 350px; overflow: hidden; position: relative;">
                        ...
                        <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.8)); padding: 30px 20px 20px;">
                            <h4 class="text-white mb-1">{{ __('Chief Executive Officer') }}</h4>
                            <p class="text-white mb-0" style="font-size: 0.9rem;">{{ __('Leadership') }}</p>
                        </div>
                    </div>
                    <div class="team-content" style="padding: 25px;">
                        <p style="color: #666; line-height: 1.8; margin-bottom: 20px;">{{ __("Leading InstantPayment Solutions with a vision to transform Tanzania's digital payment landscape through innovation and strategic partnerships.") }}</p>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="team-card wow fadeInUp" data-wow-delay="0.2s" style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 30px rgba(0,0,0,0.08); transition: transform 0.3s; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                    <div class="team-image" style="height: 350px; overflow: hidden; position: relative;">
                        ...
                        <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.8)); padding: 30px 20px 20px;">
                            <h4 class="text-white mb-1">{{ __('Chief Technology Officer') }}</h4>
                            <p class="text-white mb-0" style="font-size: 0.9rem;">{{ __('Technology') }}</p>
                        </div>
                    </div>
                    <div class="team-content" style="padding: 25px;">
                        <p style="color: #666; line-height: 1.8; margin-bottom: 20px;">{{ __('Overseeing all technology development, ensuring our payment infrastructure is secure, scalable, and meets the highest industry standards.') }}</p>
                        <div class="team-social">
                            <a href="#" class="me-2" style="color: #ea2429; font-size: 1.2rem;"><i class="fab fa-linkedin"></i></a>
                            <a href="#" class="me-2" style="color: #ea2429; font-size: 1.2rem;"><i class="fab fa-twitter"></i></a>
                            <a href="#" style="color: #ea2429; font-size: 1.2rem;"><i class="fas fa-envelope"></i></a>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="team-card wow fadeInUp" data-wow-delay="0.4s" style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 30px rgba(0,0,0,0.08); transition: transform 0.3s; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                    <div class="team-image" style="height: 350px; overflow: hidden; position: relative;">
                        ...
                        <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.8)); padding: 30px 20px 20px;">
                            <h4 class="text-white mb-1">{{ __('Chief Financial Officer') }}</h4>
                            <p class="text-white mb-0" style="font-size: 0.9rem;">{{ __('Finance') }}</p>
                        </div>
                    </div>
                    <div class="team-content" style="padding: 25px;">
                        <p style="color: #666; line-height: 1.8; margin-bottom: 20px;">{{ __('Managing financial strategy and operations, ensuring sustainable growth and compliance with regulatory requirements across all markets.') }}</p>
                        <div class="team-social">
                            <a href="#" class="me-2" style="color: #ea2429; font-size: 1.2rem;"><i class="fab fa-linkedin"></i></a>
                            <a href="#" class="me-2" style="color: #ea2429; font-size: 1.2rem;"><i class="fab fa-twitter"></i></a>
                            <a href="#" style="color: #ea2429; font-size: 1.2rem;"><i class="fas fa-envelope"></i></a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="join-content wow fadeInUp" data-wow-delay="0.2s" style="padding-left: 40px;">
                    <h3 style="color: #ea2429; font-size: 32px; margin-bottom: 20px;">{{ __('Join Our Growing Team') }}</h3>
                    <h2 class="mb-4" style="font-size: 42px;">{{ __("Be Part of Tanzania's Payment Revolution") }}</h2>

                    <p class="lead mb-4">{{ __("We're always looking for talented, passionate individuals who share our vision of transforming Tanzania's digital payment ecosystem. If you're driven by innovation and want to make a real impact, we'd love to hear from you.") }}</p>
                    ...
                    <div class="join-benefits mb-4">
                        <div class="benefit-item d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h5 class="mb-0">{{ __('Career Growth') }}</h5>
                        ...
                        <div class="benefit-item d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h5 class="mb-0">{{ __('Competitive Benefits') }}</h5>
                        ...
                        <div class="benefit-item d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-0">{{ __('Innovation Hub') }}</h5>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stat-box text-center wow fadeInUp" style="padding: 30px;">
                    ...
                    <p class="mb-0" style="color: #666; font-size: 1.1rem;">{{ __('Team Members') }}</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stat-box text-center wow fadeInUp" data-wow-delay="0.2s" style="padding: 30px;">
                    ...
                    <p class="mb-0" style="color: #666; font-size: 1.1rem;">{{ __('Departments') }}</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stat-box text-center wow fadeInUp" data-wow-delay="0.4s" style="padding: 30px;">
                    ...
                    <p class="mb-0" style="color: #666; font-size: 1.1rem;">{{ __('Years Excellence') }}</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stat-box text-center wow fadeInUp" data-wow-delay="0.6s" style="padding: 30px;">
                    ...
                    <p class="mb-0" style="color: #666; font-size: 1.1rem;">{{ __('Office Locations') }}</p>
                </div>
            </div>
        </div>
    </div>
