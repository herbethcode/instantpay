...
@section('content')
<!-- Page Header Start -->
<div class="page-header" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ asset('homepage/contact-hero.jpg') }}'); background-size: cover; background-position: top center; min-height: 450px;">
    <div class="container">
